...
public class PauseMultiplayerScreen implements Screen {
    ...
    public PauseMultiplayerScreen(SpaceInvadersGame game, float WORLD_WIDTH, float WORLD_HEIGHT, float STAGE_WIDTH,
    ...
    private void initializeActors() {
        ...
        ImageButton playButton = ButtonUtils.createScreenNavigationButton(game, "textures/play.png", "textures/play.png", 38, 38,
            (STAGE_WIDTH - 38) / 2f, 80, ScreenState.MULTIPLAYER_GAMEPLAY);
