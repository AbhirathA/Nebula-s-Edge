...
public class PauseSingleplayerScreen implements Screen {
    ...
    public PauseSingleplayerScreen(SpaceInvadersGame game, float WORLD_WIDTH, float WORLD_HEIGHT, float STAGE_WIDTH,
