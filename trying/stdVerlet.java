...
public class stdVerlet extends LinearObject {

    public stdVerlet(int id, int x, int y, int vX, int vY, int accX, int accY, int res, int innerRad, int outerRad, int mass) {
        super(createNativeObject(id, x, y, vX, vY, accX, accY, res, innerRad, outerRad, mass));
    }

    private static native long createNativeObject(int id, int x, int y, int vX, int vY, int accX, int accY, int res, int innerRad, int outerRad, int mass);
