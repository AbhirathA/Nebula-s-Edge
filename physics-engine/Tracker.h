...
class Tracker : public LinearObj
{
    ...
    public:
        Tracker(int id, int x, int y, int v, int res, int innerRad, int outerRad, int mass, bool startX, int startSign, Obj* aim) : LinearObj(id, x, y, startX ? startSign * v : 0, startX ? 0 : startSign * v, 0, 0, innerRad, outerRad, mass), target{ aim }, velocity{v}{}
